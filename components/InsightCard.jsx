...
const InsightCard = ({ imgUrl, title, subtitle, index }) => (
  <motion.div variants={fadeIn('up', 'spring', index * 0.5, 1)} className="flex md:flex-row flex-col  gap-4">
    <img src={imgUrl} alt="planete-01" className="md:w-[270px] w-full h-[250px] rounded-[32px] object-cover" />
    <div className="w-full justify-between flex items-center">
      <div className="flex-1 md:ml-[62px] flex flex-col max-w-[630px]">
        <h4 className="font-normal lg:text-[36px] text-[26px] text-white">{title}</h4>
